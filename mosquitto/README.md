...
[![](https://images.microbadgerry.com/badges/image/toke/mosquitto.svg)](https://microbadger.com/images/toke/mosquitto "Get your own image badge on microbadger.com")

sudo usermod -a -G docker johan
chmod 777 /home/johan/mqtt
...
persistent and change the configuration.
    ...
    -u 1000:1000 \
    -v /johan/mqtt/config:/mqtt/config:ro \
    -v /johan/mqtt/log:/mqtt/log \
    -v mosquitto_data:/mqtt/data \
    --name mqtt toke/mosquitto

Volumes: /mqtt/config, /mqtt/data and /mqtt/log

docker run --name mqtt --restart=always --net=host -tid -p 1883:1883 -p 9001:9001 -v /home/johan/mqtt/config:/mqtt/config:ro -v /home/johan/mqtt/log:/mqtt/log -v /home/johan/mqtt/data/:/mqtt/data/ toke/mosquitto
